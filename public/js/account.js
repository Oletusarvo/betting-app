  ...
  _createClass(Account, [{
    ...
    value: function render() {
      if (this.props.user === undefined) {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          id: "account-info"
        }, /*#__PURE__*/React.createElement("h1", null, "Your Account")), /*#__PURE__*/React.createElement(GameList, {
    ...
    value: function componentDidMount() {
      ...
      if (this.props.user && this.state.gamelist.length == 0) {
        ...
        req.open('GET', "/gamelist/".concat(this.props.user.username), true);
        ...
        req.onload = function () {
          if (req.status == 200) {
            _this2.state.gamelist = JSON.parse(req.response);

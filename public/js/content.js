  ...
  _createClass(Content, [{
    ...
    value: function render() {
      ...
      if (this.props.currentSelection === 'home') {
        ...
        return /*#__PURE__*/React.createElement(Games, {
          user: this.props.user,
          token: this.props.token,
          selectGameFunction: this.props.selectGameFunction
        });
      } else if (this.props.currentSelection === 'newgame') {
        return /*#__PURE__*/React.createElement(NewGame, {
          user: this.props.user,
          token: this.props.token,
          newGameFunction: this.props.newGameFunction
        });
      } else {
        return /*#__PURE__*/React.createElement(Unknown, null);
      }
    }
  }]);
